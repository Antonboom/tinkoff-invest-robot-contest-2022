...
// PlaceMarketBuyOrder mocks base method.
func (m *MockOrderPlacer) PlaceMarketBuyOrder(ctx context.Context, request tinkoffinvest.PlaceOrderRequest) (tinkoffinvest.OrderID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PlaceMarketBuyOrder", ctx, request)
	ret0, _ := ret[0].(tinkoffinvest.OrderID)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// PlaceMarketBuyOrder indicates an expected call of PlaceMarketBuyOrder.
func (mr *MockOrderPlacerMockRecorder) PlaceMarketBuyOrder(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PlaceMarketBuyOrder", reflect.TypeOf((*MockOrderPlacer)(nil).PlaceMarketBuyOrder), ctx, request)
}

// PlaceMarketSellOrder mocks base method.
func (m *MockOrderPlacer) PlaceMarketSellOrder(ctx context.Context, request tinkoffinvest.PlaceOrderRequest) (tinkoffinvest.OrderID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PlaceMarketSellOrder", ctx, request)
	ret0, _ := ret[0].(tinkoffinvest.OrderID)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// PlaceMarketSellOrder indicates an expected call of PlaceMarketSellOrder.
func (mr *MockOrderPlacerMockRecorder) PlaceMarketSellOrder(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PlaceMarketSellOrder", reflect.TypeOf((*MockOrderPlacer)(nil).PlaceMarketSellOrder), ctx, request)
}
...
// WaitForOrderExecution mocks base method.
func (m *MockOrderPlacer) WaitForOrderExecution(ctx context.Context, arg1 tinkoffinvest.AccountID, arg2 tinkoffinvest.OrderID) (decimal.Decimal, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WaitForOrderExecution", ctx, arg1, arg2)
	ret0, _ := ret[0].(decimal.Decimal)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// WaitForOrderExecution indicates an expected call of WaitForOrderExecution.
func (mr *MockOrderPlacerMockRecorder) WaitForOrderExecution(ctx, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WaitForOrderExecution", reflect.TypeOf((*MockOrderPlacer)(nil).WaitForOrderExecution), ctx, arg1, arg2)
}
